...
function foo(){
  document.getElementById("test").innerHTML = "outside js file";
}
...
function newGame(data){
  ...
  lives = data.num_tries_left;
  curr_phrase = data.phrase;
  game_status = data.state;
  updateUI();
}

function updateUI(){
  document.getElementById("mylives").innerHTML = lives;
  document.getElementById("myPhrase").innerHTML = curr_phrase;
  document.getElementById("myStatus").innerHTML = game_status;
}
